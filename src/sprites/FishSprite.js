...
export class FishSprite extends OrganismSprite {
    ...
    calculateLength() {
        ...
        if (!params)
            return Math.floor((this.weight || 0) * 2); // Fallback estimate
    ...
    calculateBiologicalAge() {
        ...
        const weightRatio = (this.weight || 10) / (this.size.max || 10);
    ...
    drawDirectionArrow() {
        ...
        if (speed > 0.1) {
            ...
            this.directionArrow.lineTo(endX - arrowHeadSize * Math.cos(arrowAngle - Math.PI / 6), endY - arrowHeadSize * Math.sin(arrowAngle - Math.PI / 6));
            this.directionArrow.lineTo(endX - arrowHeadSize * Math.cos(arrowAngle + Math.PI / 6), endY - arrowHeadSize * Math.sin(arrowAngle + Math.PI / 6));
...
//# sourceMappingURL=FishSprite.js.map